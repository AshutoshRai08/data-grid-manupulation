...
const Transition = React.forwardRef(function Transition(
 ...
 const AlertDialogSlide=(props:any)=> {
  ...
  const open1=useSelector((state:RootState)=>state.modalReducer.openDialog)
  const rowPara:GridRowParams=useSelector((state:RootState)=>state.modalReducer.rowPara)
